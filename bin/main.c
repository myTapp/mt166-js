...
#ifdef _WIN32
    Sleep(1500); /* sleep for 1000 milliSeconds */
#else
    usleep(1000000);
#endif
    answer = RS232_PollComport(SERIAL_PORT, buffer, 10);
...
void menu(int command)
{
    ...
    {
    case 1:
        send_to_read_position();
        break;
    case 2:
        send_to_dispense_position();
        break;
    case 3:
        check_card_at_dispense_position();
        break;
    case 4:
        check_card_at_read_position();
        break;
    case 5:
        check_if_box_is_pre_empty();
        break;
    case 6:
        check_if_box_is_empty();
        break;
    case 7:
        discard_card();
        break;
